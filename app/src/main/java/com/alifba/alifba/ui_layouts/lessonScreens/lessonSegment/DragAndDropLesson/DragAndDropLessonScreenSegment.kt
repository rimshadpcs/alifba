...
fun DragDropLessonScreen(segment: LessonSegment.DragAndDropExperiment,onNextClicked: () -> Unit) {
    ...
    val playAudio = remember { mutableStateOf(false) } // State to control audio playback
    ...
    Column(
        ...
        TouchPressDraggable(modifier = Modifier.fillMaxSize()) {
            ...
            DropCardContainer(dropItems = segment.dropItemList, onItemDropped = { dragItem ->
                handleItemDropped(dragItem)
            })
        }
    }
}
