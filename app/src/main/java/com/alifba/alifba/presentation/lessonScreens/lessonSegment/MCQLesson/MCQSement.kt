package com.alifba.alifba.presentation.lessonScreens.lessonSegment.MCQLesson
...
fun MCQSegmentPreview() {
    val sampleSegment = LessonSegment.MCQLessonItem(
    ...
    MCQSegment(segment = sampleSegment, onNextClicked = { /* Implement action */ })
}
